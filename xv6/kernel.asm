...
80100c01:	e8 aa 39 00 00       	call   801045b0 <strlen>
...
80100c12:	e8 99 39 00 00       	call   801045b0 <strlen>
...
80100cf1:	e8 7a 38 00 00       	call   80104570 <safestrcpy>
...
80100d65:	e8 f6 33 00 00       	call   80104160 <initlock>
}
80100d6a:	c9                   	leave  
80100d6b:	c3                   	ret    
...
80100d83:	e8 c8 34 00 00       	call   80104250 <acquire>
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 8b 35 00 00       	call   80104340 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 74 35 00 00       	call   80104340 <release>
  return 0;
}
...
80100df1:	e8 5a 34 00 00       	call   80104250 <acquire>
  if(f->ref < 1)
...
80100e0a:	e8 31 35 00 00       	call   80104340 <release>
  return f;
}
...
80100e43:	e8 08 34 00 00       	call   80104250 <acquire>
  if(f->ref < 1)
...
80100e6a:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e6b:	e9 d0 34 00 00       	jmp    80104340 <release>
    return;
  }
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e8f:	e8 ac 34 00 00       	call   80104340 <release>
...
801011f8:	e8 93 31 00 00       	call   80104390 <memset>
  log_write(bp);
...
80101239:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
8010123c:	e8 0f 30 00 00       	call   80104250 <acquire>
...
80101276:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101279:	e8 c2 30 00 00       	call   80104340 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
801012be:	e8 7d 30 00 00       	call   80104340 <release>
...
801013d2:	e8 59 30 00 00       	call   80104430 <memmove>
  brelse(bp);
...
8010149b:	e8 c0 2c 00 00       	call   80104160 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801015b9:	e8 d2 2d 00 00       	call   80104390 <memset>
      dip->type = type;
...
8010166f:	00 
80101670:	e8 bb 2d 00 00       	call   80104430 <memmove>
  log_write(bp);
...
801016a1:	e8 aa 2b 00 00       	call   80104250 <acquire>
  ip->ref++;
801016a6:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
801016aa:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016b1:	e8 8a 2c 00 00       	call   80104340 <release>
  return ip;
}
...
8010175b:	e8 d0 2c 00 00       	call   80104430 <memmove>
    brelse(bp);
...
80101814:	e8 37 2a 00 00       	call   80104250 <acquire>
  ip->ref--;
...
8010182a:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
8010182b:	e9 10 2b 00 00       	jmp    80104340 <release>
void
iput(struct inode *ip)
{
  acquiresleep(&ip->lock);
...
80101837:	e8 14 2a 00 00       	call   80104250 <acquire>
    int r = ip->ref;
8010183c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010183f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101846:	e8 f5 2a 00 00       	call   80104340 <release>
    if(r == 1){
...
80101a18:	e8 13 2a 00 00       	call   80104430 <memmove>
    brelse(bp);
...
80101b14:	e8 17 29 00 00       	call   80104430 <memmove>
    log_write(bp);
...
80101bbb:	e8 f0 28 00 00       	call   801044b0 <strncmp>
}
80101bc0:	c9                   	leave  
80101bc1:	c3                   	ret    
...
80101c39:	e8 72 28 00 00       	call   801044b0 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101cb8:	e8 93 25 00 00       	call   80104250 <acquire>
  ip->ref++;
80101cbd:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cc1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cc8:	e8 73 26 00 00       	call   80104340 <release>
...
80101d2b:	e8 00 27 00 00       	call   80104430 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101db9:	e8 72 26 00 00       	call   80104430 <memmove>
    name[len] = 0;
...
80101eb3:	e8 68 26 00 00       	call   80104520 <strncpy>
  de.inum = inum;
...
80102025:	e8 36 21 00 00       	call   80104160 <initlock>
...
801020a0:	e8 ab 21 00 00       	call   80104250 <acquire>
...
801020cc:	e8 cf 1d 00 00       	call   80103ea0 <wakeup>
...
801020e6:	e8 55 22 00 00       	call   80104340 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
80102176:	e8 d5 20 00 00       	call   80104250 <acquire>
...
801021d5:	5d                   	pop    %ebp
  ...
  release(&idelock);
801021d6:	e9 65 21 00 00       	jmp    80104340 <release>
...
8010233a:	e8 51 20 00 00       	call   80104390 <memset>
...
80102373:	5d                   	pop    %ebp
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102374:	e9 c7 1f 00 00       	jmp    80104340 <release>
...
80102387:	e8 c4 1e 00 00       	call   80104250 <acquire>
...
8010240a:	e8 51 1d 00 00       	call   80104160 <initlock>
...
801024dd:	e8 5e 1e 00 00       	call   80104340 <release>
  return (char*)r;
}
...
801024f7:	e8 54 1d 00 00       	call   80104250 <acquire>
...
801028ac:	e8 2f 1b 00 00       	call   801043e0 <memcmp>
...
801029d7:	e8 54 1a 00 00       	call   80104430 <memmove>
...
80102a9a:	e8 c1 16 00 00       	call   80104160 <initlock>
  readsb(dev, &sb);
...
80102b2d:	e8 1e 17 00 00       	call   80104250 <acquire>
...
80102b75:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b7a:	e8 c1 17 00 00       	call   80104340 <release>
      break;
    }
  }
}
...
80102ba0:	e8 ab 16 00 00       	call   80104250 <acquire>
  log.outstanding -= 1;
...
80102bd8:	00 00 00 
  ...
  release(&log.lock);
80102bdb:	e8 60 17 00 00       	call   80104340 <release>
}
...
80102c3f:	e8 ec 17 00 00       	call   80104430 <memmove>
...
80102cfd:	e8 4e 15 00 00       	call   80104250 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d4e:	5d                   	pop    %ebp
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102d4f:	e9 ec 15 00 00       	jmp    80104340 <release>
...
80102de3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102de6:	e8 05 39 00 00       	call   801066f0 <switchkvm>
  seginit();
80102deb:	e8 40 38 00 00       	call   80106630 <seginit>
  lapicinit();
...
80102e23:	e8 58 3d 00 00       	call   80106b80 <kvmalloc>
...
80102e35:	e8 f6 37 00 00       	call   80106630 <seginit>
  picinit();       // disable pic
...
80102e4a:	e8 01 2b 00 00       	call   80105950 <uartinit>
80102e4f:	90                   	nop
  pinit();         // process table
...
80102e81:	e8 aa 15 00 00       	call   80104430 <memmove>
...
80102f5b:	e8 80 14 00 00       	call   801043e0 <memcmp>
...
80103016:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103019:	e8 c2 13 00 00       	call   801043e0 <memcmp>
...
801031f6:	80 
801031f7:	e8 64 0f 00 00       	call   80104160 <initlock>
  (*f0)->type = FD_PIPE;
...
80103281:	e8 ca 0f 00 00       	call   80104250 <acquire>
  if(writable){
...
8010329d:	e8 fe 0b 00 00       	call   80103ea0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032be:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
801032bf:	e9 7c 10 00 00       	jmp    80104340 <release>
...
801032db:	e8 c0 0b 00 00       	call   80103ea0 <wakeup>
...
801032eb:	e8 50 10 00 00       	call   80104340 <release>
    kfree((char*)p);
...
8010330f:	e8 3c 0f 00 00       	call   80104250 <acquire>
  for(i = 0; i < n; i++){
...
8010335f:	e8 3c 0b 00 00       	call   80103ea0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103392:	e8 a9 0f 00 00       	call   80104340 <release>
        return -1;
...
801033da:	e8 c1 0a 00 00       	call   80103ea0 <wakeup>
  release(&p->lock);
801033df:	89 1c 24             	mov    %ebx,(%esp)
801033e2:	e8 59 0f 00 00       	call   80104340 <release>
  return n;
...
80103402:	e8 49 0e 00 00       	call   80104250 <acquire>
...
8010345b:	e8 e0 0e 00 00       	call   80104340 <release>
...
801034b5:	e8 e6 09 00 00       	call   80103ea0 <wakeup>
  release(&p->lock);
801034ba:	89 34 24             	mov    %esi,(%esp)
801034bd:	e8 7e 0e 00 00       	call   80104340 <release>
  return i;
}
...
801034e3:	e8 68 0d 00 00       	call   80104250 <acquire>
...
8010351e:	89 43 10             	mov    %eax,0x10(%ebx)
  ...
  release(&ptable.lock);
80103521:	e8 1a 0e 00 00       	call   80104340 <release>
...
8010353d:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103540:	c7 40 14 75 55 10 80 	movl   $0x80105575,0x14(%eax)
...
8010355a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010355d:	e8 2e 0e 00 00       	call   80104390 <memset>
...
8010357f:	e8 bc 0d 00 00       	call   80104340 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
801035ad:	e8 8e 0d 00 00       	call   80104340 <release>
...
80103605:	e8 56 0b 00 00       	call   80104160 <initlock>
}
8010360a:	c9                   	leave  
8010360b:	c3                   	ret    
...
801036f3:	e8 f8 33 00 00       	call   80106af0 <setupkvm>
...
80103715:	80 
80103716:	e8 05 31 00 00       	call   80106820 <inituvm>
  p->sz = PGSIZE;
...
80103737:	e8 54 0c 00 00       	call   80104390 <memset>
...
8010379e:	e8 cd 0d 00 00       	call   80104570 <safestrcpy>
  p->cwd = namei("/");
...
801037b9:	e8 92 0a 00 00       	call   80104250 <acquire>
...
801037cc:	e8 6f 0b 00 00       	call   80104340 <release>
}
...
80103819:	e8 42 31 00 00       	call   80106960 <allocuvm>
...
80103827:	e8 e4 2e 00 00       	call   80106710 <switchuvm>
  return 0;
...
8010384a:	e8 01 32 00 00       	call   80106a50 <deallocuvm>
...
8010388e:	e8 3d 33 00 00       	call   80106bd0 <copyuvm>
...
801038c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(i = 0; i < NOFILE; i++)
    if(curproc->ofile[i])
801038c8:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
...
801038db:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  *np->tf = *curproc->tf;
...
801038e7:	8b 43 6c             	mov    0x6c(%ebx),%eax

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801038ea:	83 c3 70             	add    $0x70,%ebx
  np->tf->eax = 0;
...
801038f8:	89 47 6c             	mov    %eax,0x6c(%edi)

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801038fb:	8d 47 70             	lea    0x70(%edi),%eax
801038fe:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103902:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103909:	00 
8010390a:	89 04 24             	mov    %eax,(%esp)
8010390d:	e8 5e 0c 00 00       	call   80104570 <safestrcpy>
...
8010391c:	e8 2f 09 00 00       	call   80104250 <acquire>
...
8010392f:	e8 0c 0a 00 00       	call   80104340 <release>
...
80103998:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  for(;;){
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
8010399d:	e8 ae 08 00 00       	call   80104250 <acquire>
...
801039c2:	83 eb 80             	sub    $0xffffff80,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039c5:	e8 46 2d 00 00       	call   80106710 <switchuvm>
      p->state = RUNNING;
...
801039db:	e8 eb 0b 00 00       	call   801045cb <swtch>
      switchkvm();
801039e0:	e8 0b 2d 00 00       	call   801066f0 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
801039ff:	e8 3c 09 00 00       	call   80104340 <release>
...
80103a24:	89 c3                	mov    %eax,%ebx
  ...
  if(!holding(&ptable.lock))
80103a26:	e8 b5 07 00 00       	call   801041e0 <holding>
...
80103a67:	e8 5f 0b 00 00       	call   801045cb <swtch>
  mycpu()->intena = intena;
...
80103ac4:	3b 1d b8 a5 10 80    	cmp    0x8010a5b8,%ebx
{
  ...
  curproc->status = status;
80103aca:	89 43 24             	mov    %eax,0x24(%ebx)
...
80103ad4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd]){
80103ad8:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
...
80103ae3:	e8 48 d3 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103ae8:	c7 44 b3 2c 00 00 00 	movl   $0x0,0x2c(%ebx,%esi,4)
80103aef:	00 
...
80103bdd:	e8 6e 06 00 00       	call   80104250 <acquire>
...
80103bfa:	e8 41 07 00 00       	call   80104340 <release>
}
80103bff:	c9                   	leave  
80103c00:	c3                   	ret    
...
80103c41:	e8 0a 06 00 00       	call   80104250 <acquire>
    release(lk);
80103c46:	89 34 24             	mov    %esi,(%esp)
80103c49:	e8 f2 06 00 00       	call   80104340 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103c6b:	e8 d0 06 00 00       	call   80104340 <release>
    acquire(lk);
...
80103c79:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103c7a:	e9 d1 05 00 00       	jmp    80104250 <acquire>
80103c7f:	90                   	nop
  if(lk != &ptable.lock){  //DOC: sleeplock0
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
...
80103cd4:	89 c6                	mov    %eax,%esi
  ...
  acquire(&ptable.lock);
80103cd6:	e8 75 05 00 00       	call   80104250 <acquire>
  for(;;){
...
80103d2b:	eb ae                	jmp    80103cdb <wait+0x1b>
      ...
      if(p->state == ZOMBIE){
        // Found one.
        *status = p->status;
80103d2d:	8b 53 24             	mov    0x24(%ebx),%edx
80103d30:	8b 45 08             	mov    0x8(%ebp),%eax
80103d33:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
        kfree(p->kstack);
...
80103d50:	e8 1b 2d 00 00       	call   80106a70 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103d63:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103d6a:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103d6e:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80103d75:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103d7c:	e8 bf 05 00 00       	call   80104340 <release>
    }
...
80103d91:	e8 aa 05 00 00       	call   80104340 <release>
    }
...
int
waitpid(int pid2, int* status, int options)
{
...
80103dc8:	89 c7                	mov    %eax,%edi
  ...
  acquire(&ptable.lock);
80103dca:	e8 81 04 00 00       	call   80104250 <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80103dcf:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dd1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103dd6:	eb 0b                	jmp    80103de3 <waitpid+0x33>
80103dd8:	83 eb 80             	sub    $0xffffff80,%ebx
80103ddb:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103de1:	74 1b                	je     80103dfe <waitpid+0x4e>
      if(p->pid != pid2)
80103de3:	39 73 10             	cmp    %esi,0x10(%ebx)
80103de6:	75 f0                	jne    80103dd8 <waitpid+0x28>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103de8:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103dec:	74 32                	je     80103e20 <waitpid+0x70>
...
80103df1:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103df6:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103dfc:	75 e5                	jne    80103de3 <waitpid+0x33>
        return pid;
      }
    }
...
80103e00:	74 7c                	je     80103e7e <waitpid+0xce>
80103e02:	8b 47 28             	mov    0x28(%edi),%eax
80103e05:	85 c0                	test   %eax,%eax
80103e07:	75 75                	jne    80103e7e <waitpid+0xce>
      release(&ptable.lock);
      return -1;
    }
...
80103e14:	e8 f7 fd ff ff       	call   80103c10 <sleep>
  }
80103e19:	eb b4                	jmp    80103dcf <waitpid+0x1f>
80103e1b:	90                   	nop
80103e1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      ...
      if(p->state == ZOMBIE){
        // Found one
        *status = p->status;
80103e20:	8b 53 24             	mov    0x24(%ebx),%edx
80103e23:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e26:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
        kfree(p->kstack);
80103e28:	8b 43 08             	mov    0x8(%ebx),%eax
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one
        *status = p->status;
        pid = p->pid;
80103e2b:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103e2e:	89 04 24             	mov    %eax,(%esp)
80103e31:	e8 ca e4 ff ff       	call   80102300 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103e36:	8b 43 04             	mov    0x4(%ebx),%eax
      if(p->state == ZOMBIE){
        // Found one
        *status = p->status;
        pid = p->pid;
...
80103e43:	e8 28 2c 00 00       	call   80106a70 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e48:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        *status = p->status;
        ...
        freevm(p->pgdir);
        p->pid = 0;
80103e4f:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103e56:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103e5d:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103e61:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
80103e68:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e6f:	e8 cc 04 00 00       	call   80104340 <release>
        return pid;
...
80103e85:	e8 b6 04 00 00       	call   80104340 <release>
      return -1;
80103e8a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103e8f:	eb e5                	jmp    80103e76 <waitpid+0xc6>
80103e91:	eb 0d                	jmp    80103ea0 <wakeup>
80103e93:	90                   	nop
80103e94:	90                   	nop
80103e95:	90                   	nop
80103e96:	90                   	nop
...
80103eb1:	e8 9a 03 00 00       	call   80104250 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103ef4:	e9 47 04 00 00       	jmp    80104340 <release>
...
80103f2f:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      p->killed = 1;
80103f33:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
...
80103f43:	e8 f8 03 00 00       	call   80104340 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103f67:	e8 d4 03 00 00       	call   80104340 <release>
  return -1;
}
...
80103f86:	bb c4 2d 11 80       	mov    $0x80112dc4,%ebx
...
80103f94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f98:	c7 04 24 1b 77 10 80 	movl   $0x8010771b,(%esp)
...
80103fa4:	83 eb 80             	sub    $0xffffff80,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa7:	81 fb c4 4d 11 80    	cmp    $0x80114dc4,%ebx
80103fad:	0f 84 8d 00 00 00    	je     80104040 <procdump+0xc0>
    if(p->state == UNUSED)
80103fb3:	8b 43 9c             	mov    -0x64(%ebx),%eax
...
80103fba:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103fbd:	ba a0 73 10 80       	mov    $0x801073a0,%edx
  uint pc[10];
...
8010400c:	e8 6f 01 00 00       	call   80104180 <getcallerpcs>
...
80104029:	c7 04 24 e1 6d 10 80 	movl   $0x80106de1,(%esp)
...
801040b7:	e8 54 fb ff ff       	call   80103c10 <sleep>
...
801040c2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801040c8:	e8 e3 f5 ff ff       	call   801036b0 <myproc>
...
8010427a:	75 f4                	jne    80104270 <acquire+0x20>
  ...
  __sync_synchronize();
8010427c:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
8010427f:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104282:	e8 89 f3 ff ff       	call   80103610 <mycpu>
80104287:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
8010428a:	8b 45 08             	mov    0x8(%ebp),%eax
8010428d:	83 c0 0c             	add    $0xc,%eax
80104290:	89 44 24 04          	mov    %eax,0x4(%esp)
80104294:	8d 45 08             	lea    0x8(%ebp),%eax
80104297:	89 04 24             	mov    %eax,(%esp)
8010429a:	e8 e1 fe ff ff       	call   80104180 <getcallerpcs>
}
8010429f:	83 c4 14             	add    $0x14,%esp
801042a2:	5b                   	pop    %ebx
801042a3:	5d                   	pop    %ebp
801042a4:	c3                   	ret    
...
801042ab:	e8 60 f3 ff ff       	call   80103610 <mycpu>
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
...
801042b7:	eb ac                	jmp    80104265 <acquire+0x15>
    panic("acquire");
801042b9:	c7 04 24 23 74 10 80 	movl   $0x80107423,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010431a:	c7 04 24 42 74 10 80 	movl   $0x80107442,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104326:	c7 04 24 2b 74 10 80 	movl   $0x8010742b,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104351:	c7 04 24 49 74 10 80 	movl   $0x80107449,(%esp)
...
80104363:	e8 a8 f2 ff ff       	call   80103610 <mycpu>
...
80104373:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  ...
  __sync_synchronize();
8010437a:	0f ae f0             	mfence 

  // Release the lock, equivalent to lk->locked = 0.
  // This code can't use a C assignment, since it might
  // not be atomic. A real OS would use C atomics here.
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010437d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
...
80104388:	5d                   	pop    %ebp
  ...
  popcli();
80104389:	e9 42 ff ff ff       	jmp    801042d0 <popcli>
...
801045e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801045ea:	e8 c1 f0 ff ff       	call   801036b0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801045ef:	8b 00                	mov    (%eax),%eax
801045f1:	39 d8                	cmp    %ebx,%eax
801045f3:	76 1b                	jbe    80104610 <fetchint+0x30>
801045f5:	8d 53 04             	lea    0x4(%ebx),%edx
801045f8:	39 d0                	cmp    %edx,%eax
801045fa:	72 14                	jb     80104610 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
801045fc:	8b 45 0c             	mov    0xc(%ebp),%eax
801045ff:	8b 13                	mov    (%ebx),%edx
80104601:	89 10                	mov    %edx,(%eax)
  return 0;
80104603:	31 c0                	xor    %eax,%eax
}
80104605:	83 c4 04             	add    $0x4,%esp
80104608:	5b                   	pop    %ebx
80104609:	5d                   	pop    %ebp
8010460a:	c3                   	ret    
8010460b:	90                   	nop
...
80104615:	eb ee                	jmp    80104605 <fetchint+0x25>
...
80104627:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010462a:	e8 81 f0 ff ff       	call   801036b0 <myproc>

  if(addr >= curproc->sz)
8010462f:	39 18                	cmp    %ebx,(%eax)
80104631:	76 26                	jbe    80104659 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
80104633:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104636:	89 da                	mov    %ebx,%edx
80104638:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010463a:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
8010463c:	39 c3                	cmp    %eax,%ebx
8010463e:	73 19                	jae    80104659 <fetchstr+0x39>
    if(*s == 0)
80104640:	80 3b 00             	cmpb   $0x0,(%ebx)
80104643:	75 0d                	jne    80104652 <fetchstr+0x32>
80104645:	eb 21                	jmp    80104668 <fetchstr+0x48>
80104647:	90                   	nop
80104648:	80 3a 00             	cmpb   $0x0,(%edx)
8010464b:	90                   	nop
8010464c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104650:	74 16                	je     80104668 <fetchstr+0x48>
...
80104655:	39 d0                	cmp    %edx,%eax
80104657:	77 ef                	ja     80104648 <fetchstr+0x28>
    if(*s == 0)
      return s - *pp;
  }
  return -1;
...
80104659:	83 c4 04             	add    $0x4,%esp
{
  ...
  if(addr >= curproc->sz)
    return -1;
8010465c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  for(s = *pp; s < ep; s++){
    if(*s == 0)
      return s - *pp;
  }
...
80104668:	83 c4 04             	add    $0x4,%esp
  ...
  *pp = (char*)addr;
  ...
  for(s = *pp; s < ep; s++){
    if(*s == 0)
      return s - *pp;
8010466b:	89 d0                	mov    %edx,%eax
8010466d:	29 d8                	sub    %ebx,%eax
  }
  return -1;
}
8010466f:	5b                   	pop    %ebx
...
80104684:	8b 75 0c             	mov    0xc(%ebp),%esi
80104687:	53                   	push   %ebx
80104688:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010468b:	e8 20 f0 ff ff       	call   801036b0 <myproc>
80104690:	89 75 0c             	mov    %esi,0xc(%ebp)
80104693:	8b 40 18             	mov    0x18(%eax),%eax
80104696:	8b 40 44             	mov    0x44(%eax),%eax
80104699:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
8010469d:	89 45 08             	mov    %eax,0x8(%ebp)
}
801046a0:	5b                   	pop    %ebx
801046a1:	5e                   	pop    %esi
801046a2:	5d                   	pop    %ebp
...
{
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801046a3:	e9 38 ff ff ff       	jmp    801045e0 <fetchint>
801046a8:	90                   	nop
...
801046b5:	83 ec 20             	sub    $0x20,%esp
801046b8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
...
801046c5:	89 44 24 04          	mov    %eax,0x4(%esp)
801046c9:	8b 45 08             	mov    0x8(%ebp),%eax
801046cc:	89 04 24             	mov    %eax,(%esp)
801046cf:	e8 ac ff ff ff       	call   80104680 <argint>
801046d4:	85 c0                	test   %eax,%eax
801046d6:	78 28                	js     80104700 <argptr+0x50>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
801046d8:	85 db                	test   %ebx,%ebx
801046da:	78 24                	js     80104700 <argptr+0x50>
801046dc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801046df:	8b 06                	mov    (%esi),%eax
801046e1:	39 c2                	cmp    %eax,%edx
801046e3:	73 1b                	jae    80104700 <argptr+0x50>
801046e5:	01 d3                	add    %edx,%ebx
801046e7:	39 d8                	cmp    %ebx,%eax
801046e9:	72 15                	jb     80104700 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
8010472a:	78 14                	js     80104740 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
8010472c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010472f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104733:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104736:	89 04 24             	mov    %eax,(%esp)
80104739:	e8 e2 fe ff ff       	call   80104620 <fetchstr>
}
8010473e:	c9                   	leave  
8010473f:	c3                   	ret    
int
...
80104755:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104758:	e8 53 ef ff ff       	call   801036b0 <myproc>

  num = curproc->tf->eax;
8010475d:	8b 70 18             	mov    0x18(%eax),%esi
...
syscall(void)
{
  int num;
  struct proc *curproc = myproc();
80104760:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104762:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104765:	8d 50 ff             	lea    -0x1(%eax),%edx
80104768:	83 fa 15             	cmp    $0x15,%edx
8010476b:	77 1b                	ja     80104788 <syscall+0x38>
8010476d:	8b 14 85 80 74 10 80 	mov    -0x7fef8b80(,%eax,4),%edx
80104774:	85 d2                	test   %edx,%edx
80104776:	74 10                	je     80104788 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104778:	ff d2                	call   *%edx
8010477a:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104788:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010478c:	8d 43 70             	lea    0x70(%ebx),%eax
8010478f:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80104793:	8b 43 10             	mov    0x10(%ebx),%eax
80104796:	c7 04 24 51 74 10 80 	movl   $0x80107451,(%esp)
8010479d:	89 44 24 04          	mov    %eax,0x4(%esp)
801047a1:	e8 aa be ff ff       	call   80100650 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
801047a6:	8b 43 18             	mov    0x18(%ebx),%eax
801047a9:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
801047c6:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
801047c9:	e8 e2 ee ff ff       	call   801036b0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
801047ce:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
801047d0:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
801047d4:	85 c9                	test   %ecx,%ecx
801047d6:	74 18                	je     801047f0 <fdalloc+0x30>
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
...
801047db:	83 fa 10             	cmp    $0x10,%edx
801047de:	75 f0                	jne    801047d0 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
801047ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
801047f0:	89 5c 90 2c          	mov    %ebx,0x2c(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
}
801047f4:	83 c4 04             	add    $0x4,%esp
  struct proc *curproc = myproc();
...
8010481c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
8010481f:	e8 0c d7 ff ff       	call   80101f30 <nameiparent>
...
80104831:	e8 8a ce ff ff       	call   801016c0 <ilock>
...
8010487b:	e8 a0 d0 ff ff       	call   80101920 <iunlockput>
    panic("create: dirlink");
...
8010489d:	e8 8e cc ff ff       	call   80101530 <ialloc>
...
801048af:	e8 0c ce ff ff       	call   801016c0 <ilock>
  ip->major = major;
...
801048d0:	e8 2b cd ff ff       	call   80101600 <iupdate>
...
801048ea:	e8 41 d5 ff ff       	call   80101e30 <dirlink>
...
801048f6:	e8 25 d0 ff ff       	call   80101920 <iunlockput>
...
80104951:	79 89                	jns    801048dc <create+0xdc>
      panic("create dots");
80104953:	c7 04 24 eb 74 10 80 	movl   $0x801074eb,(%esp)
8010495a:	e8 01 ba ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010495f:	c7 04 24 fa 74 10 80 	movl   $0x801074fa,(%esp)
80104966:	e8 f5 b9 ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010496b:	c7 04 24 dc 74 10 80 	movl   $0x801074dc,(%esp)
...
801049a1:	78 2d                	js     801049d0 <argfd.constprop.0+0x50>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801049a3:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801049a7:	77 27                	ja     801049d0 <argfd.constprop.0+0x50>
801049a9:	e8 02 ed ff ff       	call   801036b0 <myproc>
801049ae:	8b 55 f4             	mov    -0xc(%ebp),%edx
801049b1:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
801049b5:	85 c0                	test   %eax,%eax
801049b7:	74 17                	je     801049d0 <argfd.constprop.0+0x50>
    return -1;
  if(pfd)
801049b9:	85 f6                	test   %esi,%esi
801049bb:	74 02                	je     801049bf <argfd.constprop.0+0x3f>
    *pfd = fd;
801049bd:	89 16                	mov    %edx,(%esi)
  if(pf)
801049bf:	85 db                	test   %ebx,%ebx
801049c1:	74 1d                	je     801049e0 <argfd.constprop.0+0x60>
    *pf = f;
...
801049d0:	83 c4 20             	add    $0x20,%esp
{
  int fd;
  struct file *f;
...
801049e2:	eb e3                	jmp    801049c7 <argfd.constprop.0+0x47>
...
801049fc:	e8 7f ff ff ff       	call   80104980 <argfd.constprop.0>
80104a01:	85 c0                	test   %eax,%eax
80104a03:	78 23                	js     80104a28 <sys_dup+0x38>
    return -1;
  if((fd=fdalloc(f)) < 0)
80104a05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a08:	e8 b3 fd ff ff       	call   801047c0 <fdalloc>
80104a0d:	85 c0                	test   %eax,%eax
80104a0f:	89 c3                	mov    %eax,%ebx
80104a11:	78 15                	js     80104a28 <sys_dup+0x38>
    return -1;
  filedup(f);
80104a13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a16:	89 04 24             	mov    %eax,(%esp)
80104a19:	e8 c2 c3 ff ff       	call   80100de0 <filedup>
  return fd;
...
80104a2d:	eb f1                	jmp    80104a20 <sys_dup+0x30>
80104a2f:	90                   	nop
...
80104a3b:	e8 40 ff ff ff       	call   80104980 <argfd.constprop.0>
80104a40:	85 c0                	test   %eax,%eax
80104a42:	78 54                	js     80104a98 <sys_read+0x68>
80104a44:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104a47:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a4b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104a52:	e8 29 fc ff ff       	call   80104680 <argint>
80104a57:	85 c0                	test   %eax,%eax
80104a59:	78 3d                	js     80104a98 <sys_read+0x68>
...
80104a70:	e8 3b fc ff ff       	call   801046b0 <argptr>
80104a75:	85 c0                	test   %eax,%eax
80104a77:	78 1f                	js     80104a98 <sys_read+0x68>
    return -1;
...
80104a8d:	e8 ae c4 ff ff       	call   80100f40 <fileread>
}
80104a92:	c9                   	leave  
80104a93:	c3                   	ret    
...
80104aab:	e8 d0 fe ff ff       	call   80104980 <argfd.constprop.0>
80104ab0:	85 c0                	test   %eax,%eax
80104ab2:	78 54                	js     80104b08 <sys_write+0x68>
80104ab4:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104ab7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104abb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104ac2:	e8 b9 fb ff ff       	call   80104680 <argint>
80104ac7:	85 c0                	test   %eax,%eax
80104ac9:	78 3d                	js     80104b08 <sys_write+0x68>
...
80104ae0:	e8 cb fb ff ff       	call   801046b0 <argptr>
80104ae5:	85 c0                	test   %eax,%eax
80104ae7:	78 1f                	js     80104b08 <sys_write+0x68>
    return -1;
...
80104afd:	e8 de c4 ff ff       	call   80100fe0 <filewrite>
}
80104b02:	c9                   	leave  
80104b03:	c3                   	ret    
...
80104b1c:	e8 5f fe ff ff       	call   80104980 <argfd.constprop.0>
80104b21:	85 c0                	test   %eax,%eax
80104b23:	78 23                	js     80104b48 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104b25:	e8 86 eb ff ff       	call   801036b0 <myproc>
80104b2a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104b2d:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104b34:	00 
  fileclose(f);
80104b35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b38:	89 04 24             	mov    %eax,(%esp)
80104b3b:	e8 f0 c2 ff ff       	call   80100e30 <fileclose>
  return 0;
...
80104b5b:	e8 20 fe ff ff       	call   80104980 <argfd.constprop.0>
80104b60:	85 c0                	test   %eax,%eax
80104b62:	78 34                	js     80104b98 <sys_fstat+0x48>
80104b64:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b67:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104b6e:	00 
80104b6f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104b7a:	e8 31 fb ff ff       	call   801046b0 <argptr>
80104b7f:	85 c0                	test   %eax,%eax
80104b81:	78 15                	js     80104b98 <sys_fstat+0x48>
    return -1;
  return filestat(f, st);
80104b83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b86:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b8d:	89 04 24             	mov    %eax,(%esp)
80104b90:	e8 5b c3 ff ff       	call   80100ef0 <filestat>
}
80104b95:	c9                   	leave  
80104b96:	c3                   	ret    
80104b97:	90                   	nop
...
80104ba6:	83 ec 3c             	sub    $0x3c,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104ba9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104bac:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bb0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104bb7:	e8 54 fb ff ff       	call   80104710 <argstr>
80104bbc:	85 c0                	test   %eax,%eax
80104bbe:	0f 88 e6 00 00 00    	js     80104caa <sys_link+0x10a>
80104bc4:	8d 45 d0             	lea    -0x30(%ebp),%eax
80104bc7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104bcb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104bd2:	e8 39 fb ff ff       	call   80104710 <argstr>
80104bd7:	85 c0                	test   %eax,%eax
80104bd9:	0f 88 cb 00 00 00    	js     80104caa <sys_link+0x10a>
    return -1;

  begin_op();
80104bdf:	e8 3c df ff ff       	call   80102b20 <begin_op>
  if((ip = namei(old)) == 0){
80104be4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104be7:	89 04 24             	mov    %eax,(%esp)
80104bea:	e8 21 d3 ff ff       	call   80101f10 <namei>
80104bef:	85 c0                	test   %eax,%eax
80104bf1:	89 c3                	mov    %eax,%ebx
80104bf3:	0f 84 ac 00 00 00    	je     80104ca5 <sys_link+0x105>
    end_op();
    return -1;
  }
...
80104bfc:	e8 bf ca ff ff       	call   801016c0 <ilock>
  if(ip->type == T_DIR){
80104c01:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104c06:	0f 84 91 00 00 00    	je     80104c9d <sys_link+0xfd>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104c11:	8d 7d da             	lea    -0x26(%ebp),%edi
    end_op();
    return -1;
  }
  ...
  ip->nlink++;
  iupdate(ip);
80104c14:	89 1c 24             	mov    %ebx,(%esp)
80104c17:	e8 e4 c9 ff ff       	call   80101600 <iupdate>
  iunlock(ip);
80104c1c:	89 1c 24             	mov    %ebx,(%esp)
80104c1f:	e8 7c cb ff ff       	call   801017a0 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80104c24:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104c27:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104c2b:	89 04 24             	mov    %eax,(%esp)
80104c2e:	e8 fd d2 ff ff       	call   80101f30 <nameiparent>
80104c33:	85 c0                	test   %eax,%eax
80104c35:	89 c6                	mov    %eax,%esi
80104c37:	74 4f                	je     80104c88 <sys_link+0xe8>
    goto bad;
  ilock(dp);
80104c39:	89 04 24             	mov    %eax,(%esp)
80104c3c:	e8 7f ca ff ff       	call   801016c0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104c41:	8b 03                	mov    (%ebx),%eax
80104c43:	39 06                	cmp    %eax,(%esi)
80104c45:	75 39                	jne    80104c80 <sys_link+0xe0>
80104c47:	8b 43 04             	mov    0x4(%ebx),%eax
80104c4a:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104c4e:	89 34 24             	mov    %esi,(%esp)
80104c51:	89 44 24 08          	mov    %eax,0x8(%esp)
80104c55:	e8 d6 d1 ff ff       	call   80101e30 <dirlink>
80104c5a:	85 c0                	test   %eax,%eax
80104c5c:	78 22                	js     80104c80 <sys_link+0xe0>
    iunlockput(dp);
    goto bad;
  }
  iunlockput(dp);
80104c5e:	89 34 24             	mov    %esi,(%esp)
80104c61:	e8 ba cc ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104c66:	89 1c 24             	mov    %ebx,(%esp)
80104c69:	e8 72 cb ff ff       	call   801017e0 <iput>

  end_op();
80104c6e:	e8 1d df ff ff       	call   80102b90 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104c73:	83 c4 3c             	add    $0x3c,%esp
  iunlockput(dp);
  iput(ip);
...
80104c7d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    iunlockput(dp);
80104c80:	89 34 24             	mov    %esi,(%esp)
80104c83:	e8 98 cc ff ff       	call   80101920 <iunlockput>
  end_op();
...
80104c8b:	e8 30 ca ff ff       	call   801016c0 <ilock>
  ip->nlink--;
...
80104caa:	83 c4 3c             	add    $0x3c,%esp
  ilock(ip);
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
...
80104cc6:	83 ec 5c             	sub    $0x5c,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80104cc9:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104ccc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cd0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104cd7:	e8 34 fa ff ff       	call   80104710 <argstr>
80104cdc:	85 c0                	test   %eax,%eax
80104cde:	0f 88 76 01 00 00    	js     80104e5a <sys_unlink+0x19a>
    return -1;

  begin_op();
80104ce4:	e8 37 de ff ff       	call   80102b20 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104ce9:	8b 45 c0             	mov    -0x40(%ebp),%eax
80104cec:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104cef:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104cf3:	89 04 24             	mov    %eax,(%esp)
80104cf6:	e8 35 d2 ff ff       	call   80101f30 <nameiparent>
80104cfb:	85 c0                	test   %eax,%eax
80104cfd:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104d00:	0f 84 4f 01 00 00    	je     80104e55 <sys_unlink+0x195>
    end_op();
    return -1;
  }

  ilock(dp);
80104d06:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80104d09:	89 34 24             	mov    %esi,(%esp)
80104d0c:	e8 af c9 ff ff       	call   801016c0 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104d11:	c7 44 24 04 f8 74 10 	movl   $0x801074f8,0x4(%esp)
80104d18:	80 
80104d19:	89 1c 24             	mov    %ebx,(%esp)
80104d1c:	e8 7f ce ff ff       	call   80101ba0 <namecmp>
80104d21:	85 c0                	test   %eax,%eax
80104d23:	0f 84 21 01 00 00    	je     80104e4a <sys_unlink+0x18a>
80104d29:	c7 44 24 04 f7 74 10 	movl   $0x801074f7,0x4(%esp)
80104d30:	80 
80104d31:	89 1c 24             	mov    %ebx,(%esp)
80104d34:	e8 67 ce ff ff       	call   80101ba0 <namecmp>
80104d39:	85 c0                	test   %eax,%eax
80104d3b:	0f 84 09 01 00 00    	je     80104e4a <sys_unlink+0x18a>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80104d41:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104d44:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104d48:	89 44 24 08          	mov    %eax,0x8(%esp)
80104d4c:	89 34 24             	mov    %esi,(%esp)
80104d4f:	e8 7c ce ff ff       	call   80101bd0 <dirlookup>
80104d54:	85 c0                	test   %eax,%eax
80104d56:	89 c3                	mov    %eax,%ebx
80104d58:	0f 84 ec 00 00 00    	je     80104e4a <sys_unlink+0x18a>
    goto bad;
  ilock(ip);
...
80104d61:	e8 5a c9 ff ff       	call   801016c0 <ilock>
  ...
  if(ip->nlink < 1)
80104d66:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104d6b:	0f 8e 24 01 00 00    	jle    80104e95 <sys_unlink+0x1d5>
    panic("unlink: nlink < 1");
  if(ip->type == T_DIR && !isdirempty(ip)){
80104d71:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104d76:	8d 75 d8             	lea    -0x28(%ebp),%esi
80104d79:	74 7d                	je     80104df8 <sys_unlink+0x138>
    iunlockput(ip);
    goto bad;
  }

  memset(&de, 0, sizeof(de));
80104d7b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104d82:	00 
80104d83:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104d8a:	00 
80104d8b:	89 34 24             	mov    %esi,(%esp)
80104d8e:	e8 fd f5 ff ff       	call   80104390 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104d93:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80104d96:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104d9d:	00 
80104d9e:	89 74 24 04          	mov    %esi,0x4(%esp)
80104da2:	89 44 24 08          	mov    %eax,0x8(%esp)
80104da6:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104da9:	89 04 24             	mov    %eax,(%esp)
80104dac:	e8 bf cc ff ff       	call   80101a70 <writei>
80104db1:	83 f8 10             	cmp    $0x10,%eax
80104db4:	0f 85 cf 00 00 00    	jne    80104e89 <sys_unlink+0x1c9>
    panic("unlink: writei");
  if(ip->type == T_DIR){
80104dba:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104dbf:	0f 84 a3 00 00 00    	je     80104e68 <sys_unlink+0x1a8>
    dp->nlink--;
    iupdate(dp);
  }
  iunlockput(dp);
80104dc5:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
80104dd8:	e8 23 c8 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104ddd:	89 1c 24             	mov    %ebx,(%esp)
80104de0:	e8 3b cb ff ff       	call   80101920 <iunlockput>

  end_op();
80104de5:	e8 a6 dd ff ff       	call   80102b90 <end_op>
...
80104df8:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80104dfc:	0f 86 79 ff ff ff    	jbe    80104d7b <sys_unlink+0xbb>
80104e02:	bf 20 00 00 00       	mov    $0x20,%edi
80104e07:	eb 15                	jmp    80104e1e <sys_unlink+0x15e>
80104e09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104e10:	8d 57 10             	lea    0x10(%edi),%edx
80104e13:	3b 53 58             	cmp    0x58(%ebx),%edx
80104e16:	0f 83 5f ff ff ff    	jae    80104d7b <sys_unlink+0xbb>
80104e1c:	89 d7                	mov    %edx,%edi
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104e1e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104e25:	00 
80104e26:	89 7c 24 08          	mov    %edi,0x8(%esp)
80104e2a:	89 74 24 04          	mov    %esi,0x4(%esp)
80104e2e:	89 1c 24             	mov    %ebx,(%esp)
80104e31:	e8 3a cb ff ff       	call   80101970 <readi>
80104e36:	83 f8 10             	cmp    $0x10,%eax
80104e39:	75 42                	jne    80104e7d <sys_unlink+0x1bd>
      panic("isdirempty: readi");
    if(de.inum != 0)
80104e3b:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80104e40:	74 ce                	je     80104e10 <sys_unlink+0x150>
  ilock(ip);
...
80104e45:	e8 d6 ca ff ff       	call   80101920 <iunlockput>
  end_op();
...
bad:
  iunlockput(dp);
80104e4a:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104e4d:	89 04 24             	mov    %eax,(%esp)
80104e50:	e8 cb ca ff ff       	call   80101920 <iunlockput>
  end_op();
80104e55:	e8 36 dd ff ff       	call   80102b90 <end_op>
  return -1;
}
...
80104e67:	90                   	nop
  ...
  if(ip->type == T_DIR){
    dp->nlink--;
80104e68:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104e6b:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
80104e70:	89 04 24             	mov    %eax,(%esp)
80104e73:	e8 88 c7 ff ff       	call   80101600 <iupdate>
80104e78:	e9 48 ff ff ff       	jmp    80104dc5 <sys_unlink+0x105>
  int off;
  struct dirent de;
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104e7d:	c7 04 24 1c 75 10 80 	movl   $0x8010751c,(%esp)
80104e84:	e8 d7 b4 ff ff       	call   80100360 <panic>
    goto bad;
  }
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104e89:	c7 04 24 2e 75 10 80 	movl   $0x8010752e,(%esp)
80104e90:	e8 cb b4 ff ff       	call   80100360 <panic>
  if((ip = dirlookup(dp, name, &off)) == 0)
    goto bad;
  ilock(ip);
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104e95:	c7 04 24 0a 75 10 80 	movl   $0x8010750a,(%esp)
80104e9c:	e8 bf b4 ff ff       	call   80100360 <panic>
...
80104eb6:	83 ec 2c             	sub    $0x2c,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104eb9:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104ebc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ec0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104ec7:	e8 44 f8 ff ff       	call   80104710 <argstr>
80104ecc:	85 c0                	test   %eax,%eax
80104ece:	0f 88 d1 00 00 00    	js     80104fa5 <sys_open+0xf5>
80104ed4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104ed7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104edb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104ee2:	e8 99 f7 ff ff       	call   80104680 <argint>
80104ee7:	85 c0                	test   %eax,%eax
80104ee9:	0f 88 b6 00 00 00    	js     80104fa5 <sys_open+0xf5>
    return -1;

  begin_op();
80104eef:	e8 2c dc ff ff       	call   80102b20 <begin_op>

  if(omode & O_CREATE){
80104ef4:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80104ef8:	0f 85 82 00 00 00    	jne    80104f80 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
    ...
    if((ip = namei(path)) == 0){
80104efe:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104f01:	89 04 24             	mov    %eax,(%esp)
80104f04:	e8 07 d0 ff ff       	call   80101f10 <namei>
80104f09:	85 c0                	test   %eax,%eax
80104f0b:	89 c6                	mov    %eax,%esi
80104f0d:	0f 84 8d 00 00 00    	je     80104fa0 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
80104f13:	89 04 24             	mov    %eax,(%esp)
80104f16:	e8 a5 c7 ff ff       	call   801016c0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104f1b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104f20:	0f 84 92 00 00 00    	je     80104fb8 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
80104f26:	e8 45 be ff ff       	call   80100d70 <filealloc>
80104f2b:	85 c0                	test   %eax,%eax
80104f2d:	89 c3                	mov    %eax,%ebx
80104f2f:	0f 84 93 00 00 00    	je     80104fc8 <sys_open+0x118>
80104f35:	e8 86 f8 ff ff       	call   801047c0 <fdalloc>
80104f3a:	85 c0                	test   %eax,%eax
80104f3c:	89 c7                	mov    %eax,%edi
80104f3e:	0f 88 94 00 00 00    	js     80104fd8 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80104f44:	89 34 24             	mov    %esi,(%esp)
80104f47:	e8 54 c8 ff ff       	call   801017a0 <iunlock>
  end_op();
80104f4c:	e8 3f dc ff ff       	call   80102b90 <end_op>

  f->type = FD_INODE;
80104f51:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80104f57:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  }
  iunlock(ip);
  end_op();
  ...
  f->type = FD_INODE;
  f->ip = ip;
80104f5a:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104f5d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104f64:	89 c2                	mov    %eax,%edx
80104f66:	83 e2 01             	and    $0x1,%edx
80104f69:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104f6c:	a8 03                	test   $0x3,%al
  end_op();
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80104f6e:	88 53 08             	mov    %dl,0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
  return fd;
80104f71:	89 f8                	mov    %edi,%eax
  ...
  f->readable = !(omode & O_WRONLY);
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104f73:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104f77:	83 c4 2c             	add    $0x2c,%esp
80104f7a:	5b                   	pop    %ebx
80104f7b:	5e                   	pop    %esi
80104f7c:	5f                   	pop    %edi
80104f7d:	5d                   	pop    %ebp
...
80104f80:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104f83:	31 c9                	xor    %ecx,%ecx
80104f85:	ba 02 00 00 00       	mov    $0x2,%edx
80104f8a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104f91:	e8 6a f8 ff ff       	call   80104800 <create>
    if(ip == 0){
...
80104f98:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80104f9a:	75 8a                	jne    80104f26 <sys_open+0x76>
...
80104fa5:	83 c4 2c             	add    $0x2c,%esp
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    if(f)
      fileclose(f);
    iunlockput(ip);
...
80104fb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    ilock(ip);
    if(ip->type == T_DIR && omode != O_RDONLY){
80104fb8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104fbb:	85 c0                	test   %eax,%eax
80104fbd:	0f 84 63 ff ff ff    	je     80104f26 <sys_open+0x76>
80104fc3:	90                   	nop
...
80104fcb:	e8 50 c9 ff ff       	call   80101920 <iunlockput>
80104fd0:	eb ce                	jmp    80104fa0 <sys_open+0xf0>
...
80104fdb:	e8 50 be ff ff       	call   80100e30 <fileclose>
80104fe0:	eb e6                	jmp    80104fc8 <sys_open+0x118>
...
80104ff3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80104ff6:	e8 25 db ff ff       	call   80102b20 <begin_op>
...
8010502f:	e8 ec c8 ff ff       	call   80101920 <iunlockput>
  end_op();
80105034:	e8 57 db ff ff       	call   80102b90 <end_op>
  return 0;
...
8010503d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    end_op();
80105040:	e8 4b db ff ff       	call   80102b90 <end_op>
    return -1;
...
801050bf:	e8 5c c8 ff ff       	call   80101920 <iunlockput>
  end_op();
...
801050e5:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
801050e8:	e8 c3 e5 ff ff       	call   801036b0 <myproc>
801050ed:	89 c6                	mov    %eax,%esi
  
  begin_op();
801050ef:	e8 2c da ff ff       	call   80102b20 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801050f4:	8d 45 f4             	lea    -0xc(%ebp),%eax
801050f7:	89 44 24 04          	mov    %eax,0x4(%esp)
801050fb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105102:	e8 09 f6 ff ff       	call   80104710 <argstr>
80105107:	85 c0                	test   %eax,%eax
80105109:	78 4a                	js     80105155 <sys_chdir+0x75>
8010510b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010510e:	89 04 24             	mov    %eax,(%esp)
80105111:	e8 fa cd ff ff       	call   80101f10 <namei>
80105116:	85 c0                	test   %eax,%eax
80105118:	89 c3                	mov    %eax,%ebx
8010511a:	74 39                	je     80105155 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
8010511c:	89 04 24             	mov    %eax,(%esp)
8010511f:	e8 9c c5 ff ff       	call   801016c0 <ilock>
  if(ip->type != T_DIR){
80105124:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
80105129:	89 1c 24             	mov    %ebx,(%esp)
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
    return -1;
  }
  ilock(ip);
  if(ip->type != T_DIR){
8010512c:	75 22                	jne    80105150 <sys_chdir+0x70>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
8010512e:	e8 6d c6 ff ff       	call   801017a0 <iunlock>
  iput(curproc->cwd);
80105133:	8b 46 6c             	mov    0x6c(%esi),%eax
80105136:	89 04 24             	mov    %eax,(%esp)
80105139:	e8 a2 c6 ff ff       	call   801017e0 <iput>
  end_op();
8010513e:	e8 4d da ff ff       	call   80102b90 <end_op>
  curproc->cwd = ip;
  return 0;
80105143:	31 c0                	xor    %eax,%eax
  ...
  end_op();
  curproc->cwd = ip;
80105145:	89 5e 6c             	mov    %ebx,0x6c(%esi)
  return 0;
}
80105148:	83 c4 20             	add    $0x20,%esp
8010514b:	5b                   	pop    %ebx
8010514c:	5e                   	pop    %esi
8010514d:	5d                   	pop    %ebp
8010514e:	c3                   	ret    
...
8010515a:	83 c4 20             	add    $0x20,%esp
  }
  ilock(ip);
  if(ip->type != T_DIR){
    iunlockput(ip);
...
801051db:	e8 b0 f1 ff ff       	call   80104390 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
801051f0:	e8 eb f3 ff ff       	call   801045e0 <fetchint>
...
8010520a:	e8 11 f4 ff ff       	call   80104620 <fetchstr>
...
8010524e:	e8 4d b7 ff ff       	call   801009a0 <exec>
}
...
80105267:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010526a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105271:	00 
80105272:	89 44 24 04          	mov    %eax,0x4(%esp)
80105276:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010527d:	e8 2e f4 ff ff       	call   801046b0 <argptr>
80105282:	85 c0                	test   %eax,%eax
80105284:	78 6d                	js     801052f3 <sys_pipe+0x93>
    return -1;
...
80105293:	e8 e8 de ff ff       	call   80103180 <pipealloc>
80105298:	85 c0                	test   %eax,%eax
8010529a:	78 57                	js     801052f3 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010529c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010529f:	e8 1c f5 ff ff       	call   801047c0 <fdalloc>
801052a4:	85 c0                	test   %eax,%eax
801052a6:	89 c3                	mov    %eax,%ebx
801052a8:	78 33                	js     801052dd <sys_pipe+0x7d>
801052aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052ad:	e8 0e f5 ff ff       	call   801047c0 <fdalloc>
801052b2:	85 c0                	test   %eax,%eax
801052b4:	78 1a                	js     801052d0 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
801052b6:	8b 55 ec             	mov    -0x14(%ebp),%edx
801052b9:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
801052bb:	8b 55 ec             	mov    -0x14(%ebp),%edx
801052be:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
}
801052c1:	83 c4 24             	add    $0x24,%esp
    fileclose(wf);
    return -1;
  }
  fd[0] = fd0;
...
801052c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
801052d0:	e8 db e3 ff ff       	call   801036b0 <myproc>
801052d5:	c7 44 98 2c 00 00 00 	movl   $0x0,0x2c(%eax,%ebx,4)
801052dc:	00 
    fileclose(rf);
801052dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052e0:	89 04 24             	mov    %eax,(%esp)
801052e3:	e8 48 bb ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
801052e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052eb:	89 04 24             	mov    %eax,(%esp)
801052ee:	e8 3d bb ff ff       	call   80100e30 <fileclose>
    return -1;
  }
  fd[0] = fd0;
  fd[1] = fd1;
...
801052f3:	83 c4 24             	add    $0x24,%esp
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
...
{
  return fork();
80105304:	e9 57 e5 ff ff       	jmp    80103860 <fork>
...
80105324:	e8 57 f3 ff ff       	call   80104680 <argint>
  exit(status);
80105329:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010532c:	89 04 24             	mov    %eax,(%esp)
8010532f:	e8 7c e7 ff ff       	call   80103ab0 <exit>
...
8010535c:	e8 4f f3 ff ff       	call   801046b0 <argptr>
  return wait(status);
80105361:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105364:	89 04 24             	mov    %eax,(%esp)
80105367:	e8 54 e9 ff ff       	call   80103cc0 <wait>
}
8010536c:	c9                   	leave  
8010536d:	c3                   	ret    
...
8010537d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105384:	e8 f7 f2 ff ff       	call   80104680 <argint>
  argint(0, &pid);
80105389:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010538c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105390:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105397:	e8 e4 f2 ff ff       	call   80104680 <argint>
  argptr(1, (char**)&p, sizeof(int*));
8010539c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010539f:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801053a6:	00 
801053a7:	89 44 24 04          	mov    %eax,0x4(%esp)
801053ab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801053b2:	e8 f9 f2 ff ff       	call   801046b0 <argptr>
  return waitpid(pid, p, option);
801053b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053ba:	89 44 24 08          	mov    %eax,0x8(%esp)
801053be:	8b 45 ec             	mov    -0x14(%ebp),%eax
801053c1:	89 44 24 04          	mov    %eax,0x4(%esp)
801053c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053c8:	89 04 24             	mov    %eax,(%esp)
801053cb:	e8 e0 e9 ff ff       	call   80103db0 <waitpid>
}
801053d0:	c9                   	leave  
801053d1:	c3                   	ret    
...
801053f4:	e8 87 f2 ff ff       	call   80104680 <argint>
...
80105403:	e8 f8 ea ff ff       	call   80103f00 <kill>
}
80105408:	c9                   	leave  
80105409:	c3                   	ret    
...
80105423:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105426:	e8 85 e2 ff ff       	call   801036b0 <myproc>
...
80105445:	e8 36 f2 ff ff       	call   80104680 <argint>
8010544a:	85 c0                	test   %eax,%eax
8010544c:	78 22                	js     80105470 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010544e:	e8 5d e2 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
...
8010545b:	e8 90 e3 ff ff       	call   801037f0 <growproc>
...
801054cf:	e8 3c e7 ff ff       	call   80103c10 <sleep>
...
801054de:	73 28                	jae    80105508 <sys_sleep+0x88>
    if(myproc()->killed){
801054e0:	e8 cb e1 ff ff       	call   801036b0 <myproc>
801054e5:	8b 40 28             	mov    0x28(%eax),%eax
801054e8:	85 c0                	test   %eax,%eax
801054ea:	74 d4                	je     801054c0 <sys_sleep+0x40>
      release(&tickslock);
801054ec:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801054f3:	e8 48 ee ff ff       	call   80104340 <release>
      return -1;
...
8010550f:	e8 2c ee ff ff       	call   80104340 <release>
  return 0;
}
...
80105606:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  ...
  initlock(&tickslock, "time");
8010560c:	e8 4f eb ff ff       	call   80104160 <initlock>
}
80105611:	c9                   	leave  
80105612:	c3                   	ret    
...
80105678:	e8 33 e0 ff ff       	call   801036b0 <myproc>
...
8010569c:	e8 ef df ff ff       	call   80103690 <cpuid>
...
801056ce:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801056d1:	83 c6 70             	add    $0x70,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
801056ee:	e8 5d af ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
801056f3:	e8 b8 df ff ff       	call   801036b0 <myproc>
801056f8:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
801056ff:	90                   	nop
  }
...
8010570e:	8b 50 28             	mov    0x28(%eax),%edx
...
80105715:	e8 96 df ff ff       	call   801036b0 <myproc>
...
80105729:	74 55                	je     80105780 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010572b:	e8 80 df ff ff       	call   801036b0 <myproc>
80105730:	85 c0                	test   %eax,%eax
80105732:	74 1d                	je     80105751 <trap+0x101>
80105734:	e8 77 df ff ff       	call   801036b0 <myproc>
80105739:	8b 40 28             	mov    0x28(%eax),%eax
...
80105774:	e8 37 e3 ff ff       	call   80103ab0 <exit>
...
80105784:	75 a5                	jne    8010572b <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105786:	e8 45 e4 ff ff       	call   80103bd0 <yield>
...
8010578d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105790:	e8 fb de ff ff       	call   80103690 <cpuid>
...
801057d7:	e8 b4 de ff ff       	call   80103690 <cpuid>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105810:	e8 9b de ff ff       	call   801036b0 <myproc>
80105815:	8b 70 28             	mov    0x28(%eax),%esi
80105818:	85 f6                	test   %esi,%esi
8010581a:	75 34                	jne    80105850 <trap+0x200>
      exit(0);
    myproc()->tf = tf;
8010581c:	e8 8f de ff ff       	call   801036b0 <myproc>
80105821:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105824:	e8 27 ef ff ff       	call   80104750 <syscall>
    if(myproc()->killed)
80105829:	e8 82 de ff ff       	call   801036b0 <myproc>
8010582e:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105846:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit(0);
80105847:	e9 64 e2 ff ff       	jmp    80103ab0 <exit>
...
80105857:	e8 54 e2 ff ff       	call   80103ab0 <exit>
...
80105867:	e8 e4 e9 ff ff       	call   80104250 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105873:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010587a:	e8 21 e6 ff ff       	call   80103ea0 <wakeup>
      release(&tickslock);
8010587f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105886:	e8 b5 ea ff ff       	call   80104340 <release>
...
80105896:	e8 f5 dd ff ff       	call   80103690 <cpuid>
...
80105927:	e8 84 ce ff ff       	call   801027b0 <microdelay>
{
  int i;
...
801059c4:	e8 f7 c8 ff ff       	call   801022c0 <ioapicenable>
...
801064c4:	e8 e7 bf ff ff       	call   801024b0 <kalloc>
...
801064e2:	e8 a9 de ff ff       	call   80104390 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801065d3:	e8 28 bd ff ff       	call   80102300 <kfree>
      *pte = 0;
...
80106633:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106636:	e8 55 d0 ff ff       	call   80103690 <cpuid>
...
80106734:	0f 84 c3 00 00 00    	je     801067fd <switchuvm+0xed>
  ...
  pushcli();
8010673a:	e8 d1 da ff ff       	call   80104210 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010673f:	e8 cc ce ff ff       	call   80103610 <mycpu>
80106744:	89 c3                	mov    %eax,%ebx
80106746:	e8 c5 ce ff ff       	call   80103610 <mycpu>
8010674b:	89 c7                	mov    %eax,%edi
8010674d:	e8 be ce ff ff       	call   80103610 <mycpu>
80106752:	83 c7 08             	add    $0x8,%edi
80106755:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106758:	e8 b3 ce ff ff       	call   80103610 <mycpu>
...
80106799:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010679e:	e8 6d ce ff ff       	call   80103610 <mycpu>
801067a3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801067aa:	e8 61 ce ff ff       	call   80103610 <mycpu>
801067af:	b9 10 00 00 00       	mov    $0x10,%ecx
801067b4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801067b8:	e8 53 ce ff ff       	call   80103610 <mycpu>
...
801067c6:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801067c9:	e8 42 ce ff ff       	call   80103610 <mycpu>
...
801067eb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
801067ec:	e9 df da ff ff       	jmp    801042d0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
8010683b:	77 54                	ja     80106891 <inituvm+0x71>
  ...
  mem = kalloc();
8010683d:	e8 6e bc ff ff       	call   801024b0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106857:	e8 34 db ff ff       	call   80104390 <memset>
...
8010688b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010688c:	e9 9f db ff ff       	jmp    80104430 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
8010691d:	e8 4e b0 ff ff       	call   80101970 <readi>
...
801069a3:	e8 e8 d9 ff ff       	call   80104390 <memset>
...
801069d4:	76 2a                	jbe    80106a00 <allocuvm+0xa0>
    mem = kalloc();
801069d6:	e8 d5 ba ff ff       	call   801024b0 <kalloc>
    if(mem == 0){
...
80106a31:	e8 ca b8 ff ff       	call   80102300 <kfree>
      return 0;
...
80106abd:	e8 3e b8 ff ff       	call   80102300 <kfree>
  uint i;
...
80106ad2:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106ad3:	e9 28 b8 ff ff       	jmp    80102300 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106af8:	e8 b3 b9 ff ff       	call   801024b0 <kalloc>
...
80106b1b:	e8 70 d8 ff ff       	call   80104390 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106c0d:	e8 1e d8 ff ff       	call   80104430 <memmove>
...
80106c65:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c6b:	e8 40 b8 ff ff       	call   801024b0 <kalloc>
...
80106c7c:	e8 ef fd ff ff       	call   80106a70 <freevm>
  return 0;
...
80106c9d:	eb e4                	jmp    80106c83 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c9f:	c7 04 24 52 77 10 80 	movl   $0x80107752,(%esp)
80106ca6:	e8 b5 96 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106cab:	c7 04 24 38 77 10 80 	movl   $0x80107738,(%esp)
...
80106d3c:	e8 ef d6 ff ff       	call   80104430 <memmove>
    len -= n;
    buf += n;
